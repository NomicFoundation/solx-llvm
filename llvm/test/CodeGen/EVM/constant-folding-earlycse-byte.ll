...
define i256 @test_byte39() {
; CHECK-LABEL: define i256 @test_byte39() {
; CHECK-NEXT:    ret i256 0
;

  %res = call i256 @llvm.evm.byte(i256 14474011154664524427946373126085988481658748083205070504932198000989141204992, i256 455867356320691211509944977504407603390036387149619137164185182714736811808)
  ret i256 %res
}

define i256 @test_byte40() {
; CHECK-LABEL: define i256 @test_byte40() {
; CHECK-NEXT:    ret i256 0
;

  %res = call i256 @llvm.evm.byte(i256 14474011154664524427946373126085988481658748083205070504932198000989141204993, i256 455867356320691211509944977504407603390036387149619137164185182714736811808)
  ret i256 %res
}

define i256 @test_byte41() {
; CHECK-LABEL: define i256 @test_byte41() {
; CHECK-NEXT:    ret i256 0
;

  %res = call i256 @llvm.evm.byte(i256 14474011154664524427946373126085988481658748083205070504932198000989141205023, i256 455867356320691211509944977504407603390036387149619137164185182714736811808)
  ret i256 %res
}

define i256 @test_byte42() {
; CHECK-LABEL: define i256 @test_byte42() {
; CHECK-NEXT:    ret i256 0
;

  %res = call i256 @llvm.evm.byte(i256 28948022309329048855892746252171976963317496166410141009864396001978282409984, i256 455867356320691211509944977504407603390036387149619137164185182714736811808)
  ret i256 %res
}

define i256 @test_byte43() {
; CHECK-LABEL: define i256 @test_byte43() {
; CHECK-NEXT:    ret i256 0
;

  %res = call i256 @llvm.evm.byte(i256 43422033463993573283839119378257965444976244249615211514796594002967423614976, i256 455867356320691211509944977504407603390036387149619137164185182714736811808)
  ret i256 %res
}
