...
void EVMStackSolver::runPropagation() {
  ...
  // The code emitter materializes the callee-saved words of the spill
  // slots right at the function entry. See emitCalleeSaves. For the purpose
  // of checking the entry transformation they sit on top of the parameters.
  append_range(EntryStack, StackModel.getCalleeSavedSlots());
